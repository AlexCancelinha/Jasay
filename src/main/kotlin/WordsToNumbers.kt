...
val allowedStrings: List<String> = mutableListOf(
    "and", "zero", "one", "two", "three", "four", "five",
...
fun convertTextualNumbersInDocument(inputText: String): String {
    ...
    var words: MutableList<String> = LinkedList(cleanAndTokenizeText(inputText))
 ...
 * @return
 */
private fun cleanAndTokenizeText(sentence: String): List<String>? {
...
private fun convertWordsToNum(words: List<String>): Long {
    ...
    for (str in words) {
        ...
        val str2 = str.lowercase(Locale.getDefault()).replace("[^a-zA-Z\\s]".toRegex(), "")
        if (str2.equals("zero", ignoreCase = true)) {
            intermediateResult += 0
        } else if (str2.equals("one", ignoreCase = true)) {
            intermediateResult += 1
        } else if (str2.equals("two", ignoreCase = true)) {
            intermediateResult += 2
        } else if (str2.equals("three", ignoreCase = true)) {
            intermediateResult += 3
        } else if (str2.equals("four", ignoreCase = true)) {
            intermediateResult += 4
        } else if (str2.equals("five", ignoreCase = true)) {
            intermediateResult += 5
        } else if (str2.equals("six", ignoreCase = true)) {
            intermediateResult += 6
        } else if (str2.equals("seven", ignoreCase = true)) {
            intermediateResult += 7
        } else if (str2.equals("eight", ignoreCase = true)) {
            intermediateResult += 8
        } else if (str2.equals("nine", ignoreCase = true)) {
            intermediateResult += 9
        } else if (str2.equals("ten", ignoreCase = true)) {
            intermediateResult += 10
        } else if (str2.equals("eleven", ignoreCase = true)) {
            intermediateResult += 11
        } else if (str2.equals("twelve", ignoreCase = true)) {
            intermediateResult += 12
        } else if (str2.equals("thirteen", ignoreCase = true)) {
            intermediateResult += 13
        } else if (str2.equals("fourteen", ignoreCase = true)) {
            intermediateResult += 14
        } else if (str2.equals("fifteen", ignoreCase = true)) {
            intermediateResult += 15
        } else if (str2.equals("sixteen", ignoreCase = true)) {
            intermediateResult += 16
        } else if (str2.equals("seventeen", ignoreCase = true)) {
            intermediateResult += 17
        } else if (str2.equals("eighteen", ignoreCase = true)) {
            intermediateResult += 18
        } else if (str2.equals("nineteen", ignoreCase = true)) {
            intermediateResult += 19
        } else if (str2.equals("twenty", ignoreCase = true)) {
            intermediateResult += 20
        } else if (str2.equals("thirty", ignoreCase = true)) {
            intermediateResult += 30
        } else if (str2.equals("forty", ignoreCase = true)) {
            intermediateResult += 40
        } else if (str2.equals("fifty", ignoreCase = true)) {
            intermediateResult += 50
        } else if (str2.equals("sixty", ignoreCase = true)) {
            intermediateResult += 60
        } else if (str2.equals("seventy", ignoreCase = true)) {
            intermediateResult += 70
        } else if (str2.equals("eighty", ignoreCase = true)) {
            intermediateResult += 80
        } else if (str2.equals("ninety", ignoreCase = true)) {
            intermediateResult += 90
        } else if (str2.equals("hundred", ignoreCase = true)) {
            intermediateResult *= 100
        } else if (str2.equals("thousand", ignoreCase = true)) {
            intermediateResult *= 1000
            finalResult += intermediateResult
            intermediateResult = 0
        } else if (str2.equals("million", ignoreCase = true)) {
            intermediateResult *= 1000000
            finalResult += intermediateResult
            intermediateResult = 0
        } else if (str2.equals("billion", ignoreCase = true)) {
            intermediateResult *= 1000000000
            finalResult += intermediateResult
            intermediateResult = 0
        } else if (str2.equals("trillion", ignoreCase = true)) {
