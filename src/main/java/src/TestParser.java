...
public class TestParser extends Parser {
	...
	public static class ClassCommandContext extends ParserRuleContext {
		public TerminalNode ClassCommandKeyword() { return getToken(TestParser.ClassCommandKeyword, 0); }
		public TerminalNode TypeKeyword() { return getToken(TestParser.TypeKeyword, 0); }
		...
		public TerminalNode PrivacyKeyword() { return getToken(TestParser.PrivacyKeyword, 0); }
		public TerminalNode StaticKeyword() { return getToken(TestParser.StaticKeyword, 0); }
		public TerminalNode FinalKeyword() { return getToken(TestParser.FinalKeyword, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).enterClassCommand(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).exitClassCommand(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TestVisitor ) return ((TestVisitor<? extends T>)visitor).visitClassCommand(this);
	...
	public static class ClassCommandSetterAndGetterContext extends ParserRuleContext {
		public TerminalNode TypeToCreate() { return getToken(TestParser.TypeToCreate, 0); }
		public NameContext name() {
			return getRuleContext(NameContext.class,0);
		}
		public List<TerminalNode> Text() { return getTokens(TestParser.Text); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).enterClassCommandSetterAndGetter(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).exitClassCommandSetterAndGetter(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TestVisitor ) return ((TestVisitor<? extends T>)visitor).visitClassCommandSetterAndGetter(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AddParameterInMethodContext extends ParserRuleContext {
		...
		public TerminalNode Parameter() { return getToken(TestParser.Parameter, 0); }
		public List<TerminalNode> Text() { return getTokens(TestParser.Text); }
		public TerminalNode Text(int i) {
			return getToken(TestParser.Text, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).enterAddParameterInMethod(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).exitAddParameterInMethod(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TestVisitor ) return ((TestVisitor<? extends T>)visitor).visitAddParameterInMethod(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class NavigationCommandSimpleContext extends ParserRuleContext {
		public TerminalNode NavigationCommandKeyword() { return getToken(TestParser.NavigationCommandKeyword, 0); }
		public List<TerminalNode> Text() { return getTokens(TestParser.Text); }
		public TerminalNode Text(int i) {
			return getToken(TestParser.Text, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).enterNavigationCommandSimple(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).exitNavigationCommandSimple(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TestVisitor ) return ((TestVisitor<? extends T>)visitor).visitNavigationCommandSimple(this);
			else return visitor.visitChildren(this);
		}
	}
